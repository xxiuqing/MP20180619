...
class CafeTableViewController: UITableViewController {
    ...
    var dAddress: String?
    var fetchedArray: [CafeData] = Array()
    ...
    func downloadDataFromServer() -> Void {
        let urlString: String = "http://condi.swu.ac.kr/student/T11iphone/cafe/cafeTable.php"
            ...
            do {
                if let jsonData = try JSONSerialization.jsonObject (with: receivedData, options:.allowFragments) as? [[String: Any]] {
                    for i in 0...jsonData.count-1 {
                        let newData: CafeData = CafeData()
                        var jsonElement = jsonData[i]
                        newData.cafeNo = jsonElement["cafeNo"] as! String
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let cafe = fetchedArray[indexPath.row]
